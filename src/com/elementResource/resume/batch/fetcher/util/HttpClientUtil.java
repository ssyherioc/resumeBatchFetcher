...
public class HttpClientUtil {  
    ...
    public static void main(String[] args) throws UnsupportedEncodingException{
        ...
        params.put("layer_from", "wwwindex_rightbox_new");
        params.put("user_login", "493943240@qq.com");
        params.put("user_pwd", "cefca5c8a7bac1776dbc96858871cafb");
    	Map<String,String> headers = new HashMap<String, String>();
    	headers.put("Accept", "application/json, text/javascript; q=0.01");
    	headers.put("Accept-Language", "zh-CN");
    	headers.put("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8");
    	headers.put("X-Requested-With", "XMLHttpRequest");
    	String result = HttpClientUtil.httpPostRequest("http://www.liepin.com/webUser/login4c.json", headers,params);
